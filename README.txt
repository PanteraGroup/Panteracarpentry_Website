HOW TO PUT THE PANTERA CARPENTRY WEBSITE LIVE ON NETLIFY
========================================================
...
--------------------------------------------------------
1. Log in to Netlify and open the Pantera Carpentry site.
...
2. It creates a file called "pantera-carpentry-deploy.zip" in the main
